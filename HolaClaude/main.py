...
from core.startup_guard import run_all as _startup_guard_run
_startup_guard_run()
...
APP_NAME = os.getenv("APP_NAME", "HolaClaude")
...
class SecurityHeadersMiddleware(BaseHTTPMiddleware):
    async def dispatch(self, request: Request, call_next):
        ...
        response.headers["Content-Security-Policy"] = (
            ...
            "script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://cdn.jsdelivr.net https://justadudewhohacks.github.io; "
            "connect-src 'self' ws: wss: https://cdn.jsdelivr.net https://justadudewhohacks.github.io; "
