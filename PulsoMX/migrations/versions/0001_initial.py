...
TENANT_TABLES = [
    "tenant_plans", "venues", "rooms", "members", "membership_plans", "memberships",
    "instructors", "class_templates", "class_sessions", "bookings", "check_ins",
    "payments", "invoices", "loyalty_points", "notifications",
]
